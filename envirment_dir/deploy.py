...
class AnsibleApi2(object):
    def __init__(self,host_file_path,group_var_path,tag):
        self.tags_str = tag
...
class DeployHandler(object):
    ...
    def run_playbook(self,playbook,tag,extra_vars,msg):
        ...
        print
        print msg
        ansible_handler = AnsibleApi2(self.host_file_path, self.group_var_path, tag)
    ...
    def sync2pro(self):
        ...
        try:
            ...
            app_full_name = "%s_%s" % (self.config_dic['app_prefix'],self.config_dic['lastversion'])
